                ...
                $(function(){
                    ...
                    var _table = $table.dataTable($.extend(true,{},CONSTANT.DATA_TABLES.DEFAULT_OPTION, {
                        ajax : function(data, callback, settings) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "${pageContext.request.contextPath}/cle/getMusicInfo",
                                cache : false,  //禁用缓存
                                data: param,    //传入已封装的参数
                                dataType: "json",
                                success: function(result) {
                                    ...
                                    returnData.recordsTotal = result.cleMTotal;//总记录数
                                    returnData.recordsFiltered = result.cleMTotal;//后台不实现过滤功能，每次查询均视作全部结果
                                    returnData.data = result.cleMusicInfoTemp1s;
                    ...
                    if (data.order&&data.order.length&&data.order[0]) {
                        switch (data.order[0].column) {
                            ...
                            case 1:
                                ...
                                break;
                            case 2:
                                param.orderColumn = "composerid";//数据库列名称
                                break;
                            case 3:
                                param.orderColumn = "tag";//数据库列名称
                                break;
                            default:
